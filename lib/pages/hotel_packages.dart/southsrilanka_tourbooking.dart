...
class SouthsrilankaTourbooking extends StatefulWidget {
  const SouthsrilankaTourbooking({super.key});

  @override
  State<SouthsrilankaTourbooking> createState() =>
      _SouthsrilankaTourbookingState();
}

class _SouthsrilankaTourbookingState extends State<SouthsrilankaTourbooking> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _saveBookingDetails() async {
      ...
      String imagePath = 'assets/images/south sri-lanka-.jpg';
      String packageName = 'South SriLanka Tour Package';
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/south sri-lanka-.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
