...
import 'package:sun_lunka_app/pages/hotel_packages.dart/southsrilanka_tourbooking.dart';

class SouthsrilankaTourpackage extends StatefulWidget {
  const SouthsrilankaTourpackage({super.key});

  @override
  State<SouthsrilankaTourpackage> createState() =>
      _SouthsrilankaTourpackageState();
}

class _SouthsrilankaTourpackageState extends State<SouthsrilankaTourpackage> {
  ...
  Widget build(BuildContext context) {
    ...
    final myitems = [
      ClipRRect(
        ...
        child: Image.asset('assets/images/south sri-lanka-.jpg',
