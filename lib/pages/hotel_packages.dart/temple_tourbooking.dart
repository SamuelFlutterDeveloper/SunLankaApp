...
class TempleTourbooking extends StatefulWidget {
  const TempleTourbooking({super.key});

  @override
  State<TempleTourbooking> createState() => _TempleTourbookingState();
}

class _TempleTourbookingState extends State<TempleTourbooking> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _saveBookingDetails() async {
      ...
      String imagePath = 'assets/images/temple.jpg';
      String packageName = 'Temple Tour Package';
