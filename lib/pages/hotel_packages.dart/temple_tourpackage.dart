...
import 'package:sun_lunka_app/pages/hotel_packages.dart/temple_tourbooking.dart';

class TempleTourpackage extends StatefulWidget {
  const TempleTourpackage({super.key});

  @override
  State<TempleTourpackage> createState() => _TempleTourpackageState();
}

class _TempleTourpackageState extends State<TempleTourpackage> {
  ...
  Widget build(BuildContext context) {
    ...
    final myitems = [
      ClipRRect(
        ...
        child: Image.asset('assets/images/temple.jpg',
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => TempleTourbooking()));
                      },
                      child: Container(
                        height: 50,
                        width: sw * 0.8,
